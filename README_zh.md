...
[安装 GitHub App](https://github.com/apps/codeguardian-bot) → 每个 PR 自动审查，无需 CLI。
...
[安装 GitHub App](https://github.com/apps/codeguardian-bot) 即可实现自动 PR 审查，每个 PR 自动审查并生成 inline 评论，无需 CLI。
